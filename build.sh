...
# Build and tag image
docker image build --progress=plain --tag rdelaros/node-cpu-benchmark:0.1 .
docker tag  rdelaros/node-cpu-benchmark:0.1  rdelaros/node-cpu-benchmark:latest
docker image push --all-tags rdelaros/node-cpu-benchmark
